...
// $connectedUser c'est la table qui contient toutes les informations sur l'utilisateur connecté
    ...
    <div class="wrapper-body">
      <div class="create">
          <div class="create-header">
              <img src="<?= $connectedUser['photo'] ?>" style="position:relative; left:0" class="picture-form">
          </div>
          <div class="list" style="box-sizing: border-box;">
                <ul style="box-sizing: border-box;">
                    <li class="liste-icon-form <?= $listQ ?>" style="background-image: url('./public/icones/ic-liste<?= $listQ ?>.png');"><a href="">Liste Questions</a></li>
